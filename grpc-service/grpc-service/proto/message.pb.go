...
const file_proto_message_proto_rawDesc = "" +
	...
	"\x05reply\x18\x01 \x01(\tR\x05reply2R\n" +
	"\x0eMessageService\x12@\n" +
	"\vSendMessage\x12\x17.message.MessageRequest\x1a\x18.message.MessageResponseB\x1aZ\x18grpc-service/proto;protob\x06proto3"
